...
/*   Updated: 2025/06/30 13:49:59 by hugz             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "so_long.h"

static int get_mob_width(t_vars *v, t_mob *mob)
{
    int lx;
    int ly;
    int width;
...
static int get_mob_height(t_vars *v, t_mob *mob)
{
    int lx;
    int ly;
    int height;
...
static void mouv_mob_x_update(t_vars *v, t_mob *mob, int new_view_x, int new_mx)
{
...
static void mouv_mob_y_update(t_vars *v, t_mob *mob, int new_view_y, int new_my)
{
...
static void mouv_all_mob_one(t_vars *v, int i)
{
    if (v->mob[i].axis == 'x')
...
static void mouv_mob_simple_one(t_vars *v, int i)
{
    float next_x;
    float next_y;
    int check_x;
